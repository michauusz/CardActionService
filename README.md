# CardActionService
CardActionService is a service application developed for a recruitment task, managing allowed actions for various card types (Prepaid, Debit, Credit) based on the card status and PIN setting.
